      ...
      {/* <TransitionAbout> */}
        ...
        <div className='flex min-h-screen flex-row items-center justify-center'>
          <div className='relative flex h-full'>
            ...
            <div className='block w-[500px] -translate-x-12 self-center bg-gradient-to-r from-secondary to-primary p-1'>
              <div className="bg-background p-7">
                <h2 className='mb-5 text-2xl text-text'>Hey ! <br/>Je suis Evan Chauffour<br/>un développeur web de 20 ans</h2>
                {/* eslint-disable-next-line react/no-unescaped-entities */}
                <p className='font-sora font-thin leading-5 text-text'>Je suis passionné de développement web depuis maintenant deux ans. Mon parcours professionnel m'a conduit à me spécialiser principalement dans le front-end, où j'ai développé une forte compétence dans la création d'interfaces utilisateur attrayantes et fonctionnelles. Cependant, mes projets m'ont également amené à explorer activement le domaine du back-end. En plus du développement web, je suis passionné de sport, en particulier du basket-ball et de cinéma. Cela occupe une grande partie de mon temps en dehors du développement web. Actuellement, je suis en alternance chez <a href='https://www.weprode.com/' target='blank_' className='underline'>WeProde</a></p>
              </div>
            </div>
          </div>
        </div>
